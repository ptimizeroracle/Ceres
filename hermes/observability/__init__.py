"""
Observability toolkit for Hermes pipelines.

Provides distributed tracing with OpenTelemetry for production debugging
and performance monitoring.

Usage:
    >>> from hermes.observability import enable_tracing, TracingObserver
...
if OBSERVABILITY_AVAILABLE:
    ...
    def enable_tracing(*args, **kwargs):
        ...
        raise ImportError(
            ...
            "Install with: pip install hermes[observability]\n"
    ...
    def disable_tracing(*args, **kwargs):
        """Placeholder when observability is not installed."""
        raise ImportError(
            "Observability features require: pip install hermes[observability]"
        )
