"""
Observability toolkit for Ceres pipelines.

Provides distributed tracing with OpenTelemetry for production debugging
and performance monitoring.

Usage:
    >>> from ceres.observability import enable_tracing, TracingObserver
...
if OBSERVABILITY_AVAILABLE:
    ...
    def enable_tracing(*args, **kwargs):
        ...
        raise ImportError(
            ...
            "Install with: pip install ceres[observability]\n"
    ...
    def disable_tracing(*args, **kwargs):
        """Placeholder when observability is not installed."""
        raise ImportError(
            "Observability features require: pip install ceres[observability]"
        )
