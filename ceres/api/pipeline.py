...
from ceres.utils import RateLimiter, RetryHandler, get_logger
...
class Pipeline:
    ...
    def _execute_stages(
        ...
        if specs.processing.max_budget:
            from ceres.utils import BudgetController
        ...
        if specs.processing.enable_preprocessing:
            from ceres.utils.input_preprocessing import preprocess_dataframe
