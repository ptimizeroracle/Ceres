...
from ceres.core.models import CostEstimate, ExecutionResult, ProcessingStats
from ceres.utils.logging_utils import get_logger
...
class PipelineComposer:
    ...
    def execute(self) -> ExecutionResult:
        ...
        if self.input_df is None:
            ...
            from ceres.adapters.data_io import create_data_reader
