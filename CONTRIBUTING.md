...
# Run with coverage
uv run pytest --cov=ceres --cov-report=html
...
```bash
# Format code
uv run ruff format ceres/ tests/
...
Ceres follows a **5-layer clean architecture**:
...
Ceres uses decorators for extensibility:
...
1. Check if the bug is already reported in [Issues](https://github.com/ptimizeroracle/Ceres/issues)
2. If not, create a new issue with:
   - Clear title and description
   - Steps to reproduce
   - Expected vs actual behavior
   - Environment details (OS, Python version, Ceres version)
   - Minimal reproducible example

## 💡 Suggesting Features

1. Check [existing feature requests](https://github.com/ptimizeroracle/Ceres/issues?q=is%3Aissue+is%3Aopen+label%3Aenhancement)
...
Look for issues labeled [`good first issue`](https://github.com/ptimizeroracle/Ceres/labels/good%20first%20issue) - these are great for newcomers!

## 📞 Getting Help

- **Questions?** Open a [Discussion](https://github.com/ptimizeroracle/Ceres/discussions)
- **Bugs?** Open an [Issue](https://github.com/ptimizeroracle/Ceres/issues)
...
Every contribution, no matter how small, makes Ceres better. We appreciate your time and effort! 🌾
